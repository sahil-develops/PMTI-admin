...
const AddAdmin = () => {
  ...
  const onSubmit = async (data: AdminFormData) => {
    ...
    try {
      ...
      if (!response.ok) {
        throw new Error(responseData.error || responseData.message || 'Failed to create admin');
      }
    ...
    <div className="max-w-full mx-auto p-4">
      ...
      <nav className="flex mb-2" aria-label="Breadcrumb">
        <ol className="inline-flex items-center space-x-1 text-sm">
          ...
          <li className="text-zinc-900 font-medium">Add Admin</li>
        </ol>
      </nav>

      <h1 className="text-2xl font-bold tracking-tight mb-6">Add Administrator</h1>
      ...
      {showSuccess && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-lg p-6 max-w-sm w-full">
            ...
            <p className="text-gray-500 text-center">Administrator account has been created successfully.</p>
            <button
              onClick={() => {
